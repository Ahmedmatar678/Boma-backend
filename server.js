...
const Product = mongoose.model('Product', new mongoose.Schema({ 
    catIdx: Number, arName: String, enName: String, price: Number, img: String, arDesc: String, enDesc: String,
...
app.post('/api/auth/signup', async (req, res) => {
    try {
        ...
        if (existingUser && existingUser.isActive) return res.status(400).json({ message: 'الحساب مسجل مسبقاً' });
