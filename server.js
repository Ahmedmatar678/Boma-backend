...
// إعدادات CORS للسماح بمرور الهواتف ولوحة الإدارة
app.use(cors({
    origin: '*',
...
mongoose.connect(process.env.MONGO_URI)
    .then(() => console.log("✅ سيرفر بومة متصل بنجاح! (يدعم تعدد العملات)"))
...
const MASTER_OTP = "1111"; // كود التخطي الموحد

// 💱 سعر الصرف الخاص بالجنيه السوداني (يمكنك تعديله لاحقاً من هنا)
...
const User = mongoose.model('User', new mongoose.Schema({
    ...
    currency: { type: String, default: 'USD', enum: ['USD', 'SDG'] }, // حقل العملة
